  ...
  if (stage === 'setup') return (
    <div className="min-h-screen p-4 md:p-8 max-w-6xl mx-auto" style={{ background: 'var(--background)' }}>
      <header className="mb-8 md:mb-12 text-center relative">
          <Link href="/v1" className="absolute left-0 top-1/2 -translate-y-1/2 text-[var(--muted)] hover:text-[var(--foreground)] transition flex items-center gap-1 md:gap-2 text-sm font-bold px-2 md:px-4 py-2 rounded-full border" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
